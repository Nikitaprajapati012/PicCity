...
public class PeoplesAdapter extends RecyclerView.Adapter<PeoplesAdapter.MyViewHolder> {
    ...
    public PeoplesAdapter(Context context, ArrayList<ChatUserList> chatUserLists) {
    ...
    @Override
    public void onBindViewHolder(PeoplesAdapter.MyViewHolder holder, final int position) {
