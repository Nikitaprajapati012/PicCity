...
public class Constant {
    ...
    public static final String AppName = "PicCity";
    public static final String Prefrence = "prefrence";
    public static final String Base_URL = "http://web-medico.com/web1/pic_citi/Api/";
    ...
    public static final String CanvasSizePrice = "canvasSizePrice";
