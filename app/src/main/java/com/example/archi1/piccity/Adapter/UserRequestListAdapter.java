...
public class UserRequestListAdapter extends RecyclerView.Adapter<UserRequestListAdapter.MyViewHolder> {
    private Context mContext;
    private ArrayList<PersonalArtistPage> chatUserLists;
    private String userName,userId,otherUserId;
    public Utils utils;

    public UserRequestListAdapter(Context context, ArrayList<PersonalArtistPage> chatUserLists) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_requesteduser_list, parent, false);
        ...
        holder.btnSendRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (album.getUserStatus().equalsIgnoreCase("1")) {
                    ...
                    new SendFriendRequest(album,userId,otherUserId,position).execute();
    ...
    private class SendFriendRequest extends AsyncTask<String,String,String>
    {
        ...
        public SendFriendRequest(PersonalArtistPage album, String userid, String otheruserid, int position) {
            this.user_id=userid;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View view) {
            super(view);
            chatProfileCircular = (CircleImageView)view.findViewById(R.id.adapter_request_user_imgprofilepic);
            tvChatUserName = (TextView)view.findViewById(R.id.adapter_request_user_txtusername);
            layoutChat = (LinearLayout)view.findViewById(R.id.adapter_request_userlist_layout);
            btnSendRequest = (Button) view.findViewById(R.id.adapter_request_user_btnsendrequest);
        }
    }
}
