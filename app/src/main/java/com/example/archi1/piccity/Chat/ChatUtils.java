...
import com.example.archi1.piccity.Activity.Register;
...
//    }
    ...
    public void ChatRegister(Register signup, final String fullname, final String username, final String email, final String password) {
