package com.example.archi1.piccity.Chat;
...
public class AlistChat extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alist_chat);
        ...
        String uid = Utils.ReadSharePrefrence(getApplicationContext(), Constant.KEY_QB_USERID);
        Log.e("UID ","%%%%%% "+uid);
...
//                    Toast.makeText(getApplicationContext(), "Fail " + errors, Toast.LENGTH_SHORT).show();
        ...
        final QBPrivateChatManager chatMessage = ArtGalleryFragment.chatService.getPrivateChatManager();
//        QBPrivateChat chat = chatMessage.getChat(12);
//        boolean isLoggedIn = chatService.isLoggedIn();
        QBUser user = ArtGalleryFragment.chatService.getUser();
        String data = user.getEmail();
        final QBRequestGetBuilder requestBuilder = new QBRequestGetBuilder();
        requestBuilder.setLimit(100);

        if (dialog_id == null) {
            ArtGalleryFragment.chatService.getChatDialogs(QBDialogType.PRIVATE, requestBuilder, new QBEntityCallback<ArrayList<QBChatDialog>>() {
                @Override
...
//                    Log.e("COMPARE", " " + id + " WITH " + dialogs.get(i).getOccupants().get(0));
                        ...
                        for (int j = 0; j < dialogs.get(i).getOccupants().size(); j++) {
                            Log.d("*********","%%%%%%%%%%%%%%%%%%%%%%");
                            Log.d("UID",""+Integer.parseInt(Utils.ReadSharePrefrence(getApplicationContext(),Constant.KEY_QB_USERID)));
                            Log.d("OCCupantID",""+dialogs.get(i).getOccupants().get(j));
                            if (Integer.parseInt(Utils.ReadSharePrefrence(getApplicationContext(),Constant.KEY_QB_USERID)) == dialogs.get(i).getOccupants().get(j)) {
                                Toast.makeText(AlistChat.this, "GetCHat", Toast.LENGTH_SHORT).show();
...
//        createSession(user);
    ...
    private void getDataFromIntent() {
        if (getIntent().getExtras() != null) {
            ...
            Utils.WriteSharePrefrence(getApplicationContext(), Constant.KEY_USER_CHAT_ID, "" + user_id);
...
//            }
    ...
    private void getUserChatList() {
        ...
        requestBuilder.setLimit(100);
        if (dialog_id != null) {
            ArtGalleryFragment.chatService.getDialogMessages(qbDialog, requestBuilder, new QBEntityCallback<ArrayList<QBChatMessage>>() {
                @Override
                public void onSuccess(ArrayList<QBChatMessage> messages, Bundle args) {
...
//                ChattingFragment.chatService.getPrivateChatManager().addPrivateChatManagerListener(privateChatManagerListener);
            try {
                ...
                chatMessage.setSenderId(Integer.parseInt(Utils.ReadSharePrefrence(getApplicationContext(), Constant.KEY_QB_USERID)));
...
//                    Log.e("oponantID", "" + oponantID);
                ...
                Toast.makeText(AlistChat.this, "Exception " + e, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void selectAttachment() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AlistChat.this);
        builder.setTitle("Add Photo!");
        builder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = com.example.archi1.piccity.Constant.Utility.checkPermission(AlistChat.this);
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(AlistChat.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case 2:
                if (resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(AlistChat.this, "No Video Selected", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case 3:
                if (resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(AlistChat.this, "No Document Selected", Toast.LENGTH_SHORT).show();
                }
                break;
...
//                    scrollMyListViewToBottom();
            ...
            Toast.makeText(AlistChat.this, "something went wrong", Toast.LENGTH_SHORT).show();
        }
    }
