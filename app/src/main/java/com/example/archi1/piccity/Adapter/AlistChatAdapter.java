...
/**
 * Created by archi on 25-Mar-17.
 */

public class AlistChatAdapter extends BaseAdapter
{
    ...
    public AlistChatAdapter(Context context, ArrayList<HashMap<String, String>> msgs) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        rlReceiveImg = (RelativeLayout) view.findViewById(R.id.rlReceiverImg);
        ...
        Log.e("APP SENDER", "" + Utils.ReadSharePrefrence(context, Constant.KEY_USER_CHAT_ID));
        Log.e("LOGIN USER", "" + Utils.ReadSharePrefrence(context, Constant.KEY_QB_USERID));
//        Log.e("url", "" + hashMap.get("url"));

        if (Utils.ReadSharePrefrence(context, Constant.KEY_QB_USERID).equalsIgnoreCase(hashMap.get("recipient_id"))) {
